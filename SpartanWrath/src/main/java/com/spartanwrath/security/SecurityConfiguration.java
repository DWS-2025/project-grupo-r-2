...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain apiFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authorize -> authorize
                ...
                //MEMBERSHIP
                .requestMatchers(HttpMethod.GET,"/api/Membership").hasAnyRole("ADMIN","USER")
                .requestMatchers(HttpMethod.GET,"/api/Membership/{id}").hasAnyRole("ADMIN","USER")
    ...
    public SecurityFilterChain webFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/Membership/{id}").hasAnyRole("ADMIN","USER")
                        .requestMatchers("/Membership").hasAnyRole("ADMIN","USER")
