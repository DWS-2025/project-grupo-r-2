...
public class DatabaseInitializer {
    ...
    public void init() throws IOException,UserAlreadyRegister, InvalidUser {
        ...
        //NEW PRODUCTS
        Product product1 = new Product("Casco", "Casco de proteccion para sparring", "../../images/casco.jpg", 10.00, 2, "Cascos");
        ...
        //ADD MEMBERSHIPS TO USERS
        /*user1.setMemberships(List.of(membership1));

        //ADD MEMBERSHIPS TO CLASSES
